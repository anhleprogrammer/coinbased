...
function Home() {
  return (
    <div className="flex items-center home-container text-white m:w-screen">
      <video className="w-fit xl:w-screen" loop autoPlay muted>
        <source className="w-fit h-fit" src={video} type="video/mp4" />
      </video>
      <div className="absolute left-1/2 flex flex-col justify-center xl:w-1/3">
        <p className="xs:text-xl m:text-4xl l:text-6xl">
        ...
        <div className="flex m:gap-12 xs:gap-6">
          <input
            className="s:w-20"
            type="email"
