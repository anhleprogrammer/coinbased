...
function Home() {
  return (
    <div className="home-container">
      <video className="w-full h-fit" loop autoPlay muted>
        <source src={video} type="video/mp4" />
      </video>
      <div className="flex-col absolute text-white right-20 bottom-64 w-1/3">
        {" "}
        <p className="text-6xl mb-12">The future of blockchain is here</p>
